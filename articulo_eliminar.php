...
<body>
    ...
    <form name="frm_cliente_U" action="index.php" method="post">
        ...
        value="<?php echo $descripcion; ?>" readonly><br>
        Precio:<br>
        <input type="text" name="precio"  class="form-control"
        value="<?php echo $precio; ?>" readonly><br>
        <input type="submit" class="btn btn-dark" name="articulo_eliminar" value="Grabar">
